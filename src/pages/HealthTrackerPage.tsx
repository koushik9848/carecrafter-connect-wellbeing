...
import { HealthTrackerTabs, TabsContent } from '@/components/health-tracker/HealthTrackerTabs';
import { HistoryCalendar } from '@/components/health-tracker/HistoryCalendar';
import { AnalyticsView } from '@/components/health-tracker/AnalyticsView';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Track, analyze, and improve your health</p>
          </div>
        </div>

        <HealthTrackerTabs activeTab={activeTab} onTabChange={setActiveTab}>
          {/* Today Tab */}
